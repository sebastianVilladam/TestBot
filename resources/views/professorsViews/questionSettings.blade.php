...
@stop
@section('content')
<h1>DATOS DE  MI PREGUNTA</h1>
<hr>
<div class="container-fluid center" id="form-container">
  {!! Form::model($data, ['method' => 'PUT','route' => ['PqSettings', $data->id]]) !!}
  ...
  <div class="form-group">
    {!! Form::label('option_d', 'D:', ['class' => 'control-label']) !!}
    {!! Form::text('option_d', null, ['class' => 'form-control' , 'placeholder' => '$data->option_d']) !!}
  </div>  
  <div class="form-group">
  ...
  <div class="text-center">
    ...
    <a href="{{ route('Pquestion', $data->id) }}" class="btn btn-danger">Cancelar</a>
  </div>
</div>
@stop